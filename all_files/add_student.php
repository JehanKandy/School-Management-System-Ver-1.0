<?php
    ...
    if(isset($_POST['submit'])){
        if($_SERVER['REQUEST_METHOD'] == "POST"){
            ...
            $sql_all = "SELECT * FROM student WHERE s_id = '$id' && email = '$email'";
            ...
            if($nor > 0){
                ...
                $sql = "INSERT INTO student(s_id, fname, lname, email, gender, nic1, mobile1, dob, user_status) VALUES('$id','$fn','$ln','$email','$gender','$nic','$mobile','$dob','1')";
...
<body>
    <a href="all_student.php"><button class="all"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-plus-fill" viewBox="0 0 16 16">
  <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
  <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"/>
</svg> &nbsp All Students</button></a>
        ...
        <div class="content">
            ...
            <div class="form-container">
                <form action="<?php echo($_SERVER['PHP_SELF'])?>" method="post">
                        ...
                        <input type="text" name="fn" placeholder="Enter Student First Name">
                        <input type="text" name="ln" placeholder="Enter Student Last Name">
                        ...
                        <input type="text" name="nic" placeholder="Enter Student NIC Number">
